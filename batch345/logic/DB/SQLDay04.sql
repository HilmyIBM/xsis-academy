...
-- DB_Univ_XA.dbo.tb_mahasiswa definition

-- Drop table

-- DROP TABLE DB_Univ_XA.dbo.tb_mahasiswa;
...
CREATE TABLE tb_mahasiswa (
	...
	jenis_kelamin varchar(2) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	alamat varchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	CONSTRAINT pk_tb_mahasiswa PRIMARY KEY (nim)
);
